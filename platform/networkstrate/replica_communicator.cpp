...
void ReplicaCommunicator::BroadCastWithinShard(
  ...
  switch (node_id) {
    ...
    case 9:
    case 13:
      interShardReplicaIds = {node_id, node_id + 1, node_id + 2, node_id + 3};
      break;
    case 2:
    case 6:
    case 10:
    case 14:
      interShardReplicaIds = {node_id - 1, node_id, node_id + 1, node_id + 2};
      break;
    case 3:
    case 7:
    case 11:
    case 15:
      interShardReplicaIds = {node_id - 2, node_id - 1, node_id, node_id + 1};
      break;
    case 4:
    case 8:
    case 12:
    case 16:
      interShardReplicaIds = {node_id - 3, node_id - 2, node_id - 1, node_id};
      break;
    default:
      interShardReplicaIds = {node_id};
  }

  for (int id : interShardReplicaIds) {
